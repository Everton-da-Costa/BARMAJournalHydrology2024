...
#' `stats::make.link` by adding support for the "loglog" link.
#'
#' @details
...
#' wrapper around the base R `stats::make.link`.
#'
#' For the "loglog" link, which is not available in `stats::make.link`, the
